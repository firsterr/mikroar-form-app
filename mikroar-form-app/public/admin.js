// MikroAR Admin — TR labels + Share Image URL (DB persistent) — CLEAN BUILD
(function () {
      ...
      el("div", { class:"shell" },
        ...
        el("div", { class:"card", style:"max-width:680px; margin:0 auto;" },
          el("div", { class:"col" },
            ...
            el("input", { id:"tokenInput", class:"input", type:"password", placeholder:"ADMIN_TOKEN" }),
  ...
  function buildApp(){
    return el("div", {},
      el("style", {}, `
        ...
        .ok{ color:#065f46 } .err{ color:#b00020 } .muted{ color:#6b7280 }
      ...
      el("div", { class:"shell" },
        ...
        el("div", { id:"meta", class:"card", style:"display:none" },
          ...
          el("div", { class:"col", style:"margin-top:6px" },
            ...
            el("div", { class:"row" },
              el("input", { id:"ogImg", class:"input", placeholder:"https://…jpg/png", oninput: e=> state.shareImageUrl = e.target.value }),
  ...
  function renderApp(){ app.innerHTML=""; app.appendChild(buildApp()); loadList().catch(()=> setStatus("Liste alınamadı", true)); }
